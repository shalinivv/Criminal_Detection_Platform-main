...
# ✅ Import mail alert function
from .mail import send_criminal_alert_email
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                ...
                if matches[best_match_index]:
                    ...
                    # ✅ Send alert email when criminal detected
                    send_criminal_alert_email("varadharajseran20@gmail.com", profile)
